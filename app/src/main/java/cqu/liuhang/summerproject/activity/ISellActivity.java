...
public class ISellActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isell);
        queue = Volley.newRequestQueue(this);
        title = (TextView) findViewById(R.id.activity_topbar3_tv_title);
        listView = (ListView) findViewById(R.id.activity_isell_listview);
        back = (ImageButton) findViewById(R.id.activity_topbar3_ib_back);
        hint = (TextView) findViewById(R.id.sell_noDataHint);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ISellActivity.this, StaffActivity.class);
    ...
    private void loadData() {
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ISellActivity.this, "无法连接到服务器", Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("sellerid", LoginActivity.user != null ? "" + LoginActivity.user.getUser_id() : "" + RegisterActivity.user.getUser_id());
                return map;
            }
        };
        queue.add(request);
